    ...
    <div className='w-[100vw]'>
        <div className='w-100vw h-[40vh] bg-bgSecondaryColor'></div>
         <div className=' w-[60vw] m-auto grid grid-cols-3 gap-3'>
           { products ? products.map(product => <CardProductCategory slug={product.slug} model={product.model} brand={product.brand.logo} image={product.image[0]} price={product.price} />):<h1>cargando...</h1>}
         </div>
    </div>
  )
}

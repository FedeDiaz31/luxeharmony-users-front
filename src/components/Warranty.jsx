...
function Warranty() {
  return (
    <div className="grid grid-cols-1 tablet:grid-cols-2 laptop:grid-cols-3 w-full gap-3 px-6">
      <div className="px-5 pb-2 bg-bgSecondaryColor my-5 p text-[#fff]">
        <img
      ...
      <div className="px-5 pb-2 bg-bgSecondaryColor my-5 text-[#fff] ">
        <img
      ...
      <div className="px-5 pb-2 bg-bgSecondaryColor mb-5 laptop:my-5 text-[#fff]">
        <img
